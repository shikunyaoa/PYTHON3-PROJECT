...
# -*- coding:utf-8 -*-
# author: shikunyao
# datetime: 2018/12/4 0004 14:40
# 生成模块：获取各个账号信息并模拟登陆，随后生成Cookies并保存

import json
from selenium import webdriver
from selenium.webdriver import DesiredCapabilities
from chapter10_simulation_on.Cookies_Pool.config import *
from chapter10_simulation_on.Cookies_Pool.db import RedisClient
from chapter10_simulation_on.Cookies_Pool.cookies import WeiboCookies
...
class CookiesGenerator(object):
    ...
    def run(self):
        ...
        :return:
        '''
        accouns_usernames = self.accounts_db.usernames()
        cookies_usernames = self.cookies_db.usernames()

        for username in accouns_usernames:
